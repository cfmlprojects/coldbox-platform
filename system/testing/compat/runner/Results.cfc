...
component{
	...
	any function getResultsOutput( reporter="simple" ){
		...
		var tb = new testbox.system.testing.TestBox( directory=dir, bundles=variables.excludes, reporter=arguments.reporter );
	...
	any function getResults(){
		...
		var tb = new testbox.system.testing.TestBox( directory=dir, reporter="JUnitXML" );
		this.tb = tb;
